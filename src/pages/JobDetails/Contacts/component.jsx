...
const Contacts = ({name, address, phone, email, location}) => (
    <div className='details_contacts'>
        ...
        <a href = {`mailto:${email}`} className='details_contacts__email'>{email}</a>
        <iframe title='map' src={`https://maps.google.com/maps?q=${location.lat},${location.long}&t=&z=15&ie=UTF8&iwloc=&output=embed`}/>
    </div>
);
